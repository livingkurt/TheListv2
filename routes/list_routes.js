...
router.post('/', async (req, res) => {
  try {
    const request = await db.Lists.create({
...
router.get('/', async (req, res) => {
  ...
  try {
    const request = await db.Lists.find({})
    // Send the request back to the front end
    res.send(request)
  }
  catch (err) {
...
router.get('/:list_id', async (req, res) => {
  ...
  try {
    const request = await db.Lists.find({ list_id: req.params.list_id }).sort({ _id: -1 })
    // Send the request back to the front end
    res.send(request)
  }
  catch (err) {
...
router.get('/:priority', async (req, res) => {
  ...
  try {
    const request = await db.Lists.find({ priority: req.params.priority })
    // Send the request back to the front end
    res.send(request)
  }
  catch (err) {
...
router.get('/:id', async (req, res) => {
  ...
  try {
    const request = await db.Lists.findOne({ _id: req.params.id })
    // Send the request back to the front end
    res.send(request)
  }
  catch (err) {
...
router.delete('/:id', async (req, res) => {
  ...
  try {
    const request = await db.Lists.remove({ _id: req.params.id })
    // Send the request back to the front end
    res.send(request)
  }
  catch (err) {
...
router.delete('/', async (req, res) => {
  ...
  try {
    const request = await db.Lists.deleteMany({ title: "" })
    // Send the request back to the front end
    res.send(request)
  }
  catch (err) {
